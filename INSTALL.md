...
3. Download `240-MP-<version>-windows-x64.zip` from [Releases](https://github.com/anthonycaccese/240-mp-win/releases), extract it anywhere you like, and run `240mp.exe`.
...
```powershell
irm https://github.com/anthonycaccese/240-mp-win/releases/latest/download/install.ps1 | iex; & "$env:TEMP\install.ps1" -Uninstall
```
